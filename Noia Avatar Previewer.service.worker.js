...
/** @type {string} */
const CACHE_VERSION = '1776244725|1102446659';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["Noia Avatar Previewer.html","Noia Avatar Previewer.js","Noia Avatar Previewer.offline.html","Noia Avatar Previewer.icon.png","Noia Avatar Previewer.apple-touch-icon.png","Noia Avatar Previewer.audio.worklet.js","Noia Avatar Previewer.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Noia Avatar Previewer.wasm","Noia Avatar Previewer.pck"];
